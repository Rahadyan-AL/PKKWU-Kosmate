              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Bulanan : Rp. 200.000,00 1x Sehari',
                      style: TextStyle(
                        color: Color(0xFF846200),
                      ),
                    ),
                    ...
                    const Text(
                      'Bulanan : Rp. 400.000,00 2x Sehari',
                      style: TextStyle(
                        color: Color(0xFF846200),
                      ),
                    ),
                    const SizedBox(height: 4),
                    const Text(
                      'Mingguan : Rp. 50.000,00 1x Sehari',
                      style: TextStyle(
                        color: Color(0xFF846200),
                      ),
                    ),
                    const SizedBox(height: 4),
                    const Text(
                      'Mingguan : Rp. 100.000,00 2x Sehari',
                      style: TextStyle(
                        color: Color(0xFF846200),
                      ),
                    ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 8,
                      children: [
                        _buildButton('Bulanan 1x'),
                        _buildButton('Mingguan 1x'),
                        _buildButton('Tidak pedas'),
                        _buildButton('Bulanan 2x'),
                        _buildButton('Mingguan 2x'),
                        _buildButton('Pedas'),
                      ],
                    ),
