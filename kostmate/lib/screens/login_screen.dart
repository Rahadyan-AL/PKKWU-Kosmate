...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // Latar belakang dengan CustomPaint
          CustomPaint(
                      ...
                      child: Column(
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: const Text('LOGIN', style: TextStyle(fontFamily: 'Poppins', fontSize: 18)),
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: const Text(
                                  ' Sign Up', // Perhatikan spasi di depan
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
...
// Custom Painter untuk garis diagonal melengkung
class DiagonalCurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final pathTop = Path()
      ..moveTo(0, 100) // Mulai dari kiri, sedikit di bawah 'Sign In'
      ..quadraticBezierTo(
